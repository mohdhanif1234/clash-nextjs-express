...
import { ClashFormErrorType, ClashFormType, ClashType } from "@/types/clash.types";
...
const EditClash = ({ token, clash, open, setOpen }: { token: string, clash: ClashType, open: boolean, setOpen: Dispatch<SetStateAction<boolean>> }) => {
    ...
    const [date, setDate] = useState<Date | null>(new Date(clash.expires_at))
            ...
            <DialogContent onInteractOutside={e => e.preventDefault()}>
                <DialogHeader>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-4">
                            <Label htmlFor="expires_at" className="block">
                                Expires At
                            </Label>
                            <Popover>
